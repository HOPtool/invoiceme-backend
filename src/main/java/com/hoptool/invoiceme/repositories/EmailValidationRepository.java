...
@ApplicationScoped
@Slf4j
public class EmailValidationRepository implements  PanacheRepository<EmailVerificationLog> {
    
    
    public EmailVerificationLog doLookUpById(long tid) {
    // log.info("obj = " + obj.reference);
     return find("tid = ?1", tid).firstResult();
    
    }
    
    public EmailVerificationLog doLookUpOTP(OTPValidationRequestObj obj) {
     log.info("obj = " + obj);
    ...
    */
    ...
    @Transactional
    public EmailVerificationLog doLog(UserSignUpStepOneObj request, String otp) throws Exception {
        EmailVerificationLog obj = null;
        ...
        try 
        {
                ...
                obj.status = OTPStatus.ACTIVE.name();
    ...
    @Transactional
    public EmailVerificationLog doSync(EmailVerificationLog request, String status) throws Exception {
       // EmailVerificationLog obj = null;
        //String firstname = "", lastname ="";
        try 
        {
