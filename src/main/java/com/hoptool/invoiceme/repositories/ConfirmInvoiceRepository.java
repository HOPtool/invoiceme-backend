...
@ApplicationScoped
@Slf4j
public class ConfirmInvoiceRepository implements  PanacheRepository<InvoiceConfirmationLogs> {
    
    
    
    
    public InvoiceConfirmationLogs doLookUp(ValidateIRNRequestObj obj) {
     log.info("obj = " + obj.request_id);
     return find("requestId = ?1", obj.request_id).firstResult();
    
    }
    
    public InvoiceConfirmationLogs doLookUpByIRN(ValidateIRNRequestObj obj) {
     log.info("obj = " + obj.irn);
     return find("irn = ?1", obj.irn).firstResult();
    
    }
    
    public InvoiceConfirmationLogs doLookUpByIRNAndRequestId(ValidateIRNRequestObj obj) {
    ...
    public InvoiceConfirmationLogs doLookUpInvoiceDownload(ValidateIRNRequestObj obj) {
     log.info("obj = " + obj.request_id);
     return find("requestId = ?1", obj.request_id).firstResult();
    
    }

     public PanacheQuery<InvoiceConfirmationLogs> doList(LocalDateTime start, LocalDateTime end) {
    ...
    public PanacheQuery<InvoiceConfirmationLogs> doList(LocalDateTime start, LocalDateTime end, int status) {
    ...
    @Transactional
    public InvoiceConfirmationLogs doLog(ValidateIRNRequestObj request, LocalDateTime requestDate) throws Exception {
        InvoiceConfirmationLogs obj = null;
        try 
        {
           obj = new InvoiceConfirmationLogs();
    ...
    @Transactional
    public InvoiceConfirmationLogs doSync(ValidateIRNRequestObj request, int code, InvoiceConfirmationLogs maxCountObj) throws Exception {
        InvoiceConfirmationLogs obj = new InvoiceConfirmationLogs();
        try 
        {
           InvoiceConfirmationLogs objx = doLookUpByIRNAndRequestId(request);
    ...
    @Transactional
    public static  InvoiceConfirmationLogs doSyncConfirmationCount(InvoiceConfirmationLogs objx, InvoiceConfirmationLogs existing) throws Exception {
       InvoiceConfirmationLogs obj = new InvoiceConfirmationLogs();
       try 
        {
    ...
    public   InvoiceConfirmationLogs doLookUpInvoiceConfirmationCount(ValidateIRNRequestObj obj) {
    log.info("obj = " + obj.irn);
